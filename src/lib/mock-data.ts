...
export const mockItems = [
  ...
  },
  {
    ...
    contentType: "TEXT" as const,
    content: "- [ ] Props typed with interface\n- [ ] Error boundaries in place\n- [ ] Loading and empty states handled\n- [ ] Accessible (aria labels, keyboard nav)\n- [ ] Memoized if expensive",
    description: "Pre-flight checklist before shipping a React component",
    language: "markdown",
    typeId: "type_note",
    collectionId: "col_react",
    isFavorite: false,
    isPinned: false,
    tags: ["react", "checklist", "quality"],
  ...
  },
  {
    ...
    isFavorite: false,
    isPinned: false,
    tags: ["react", "docs", "reference"],
    createdAt: "2026-01-10T09:00:00Z",
    lastUsedAt: "2026-04-20T14:00:00Z",
  },
  {
    id: "item_6",
